-- Smart Solution ERP - 0021_place_order_branch.sql
-- place_online_order now accepts an explicit branch (selected store) and
-- falls back to the first product's branch, then first active branch.
